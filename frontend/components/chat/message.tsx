...
export function AIMessageText(props: MessageTextProps) {
  return (
    <div className="flex mr-auto w-fit max-w-[700px] bg-gray-200 dark:bg-gray-800 rounded-md px-2 py-1 mt-3">
      <div className="text-normal text-gray-800 dark:bg-gray-200 text-left break-words">
