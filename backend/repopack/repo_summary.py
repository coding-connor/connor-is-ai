...
SUMMARY_OUTPUT_PATH = 'gen_ui_backend/system_prompt/0_long_context_documents/connor_is_ai_summary.txt'
SKELETON_OUTPUT_PATH = 'gen_ui_backend/system_prompt/0_long_context_documents/connor_is_ai_skeleton.txt'
...
def analyze_codebase_with_gpt4o(codebase: str, instruction) -> AIMessage:
    ...
    try:
        ...
        messages = [
            SystemMessage(content=codebase),
...
def save_analysis_to_file(analysis: AIMessage, file_path: str) -> None:
    try:
        ...
        with open(file_path, 'w') as file:
            file.write(analysis.content if hasattr(analysis, 'content') else str(analysis))
    except IOError as e:
